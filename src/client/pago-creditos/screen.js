...
export default Screen = () => {
  ...
  const handleCreditoSeleccionado = (e) => {
    ...
    if (name === 'idCreditoSeleccionado') {
      ...
      //!valido si PlanCuotaCredito es un array sino lo es lo convierto a un array para que no de error
      if (Array.isArray(creditoElejido.PlanCuotaCredito)) {
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-400 p-2">
                      ...
                      <button onClick={handleGenerarUrlPSE}
                        ...
                        {generandoIdPse ? 'Generando...' : <img style={{ width: "50px", cursor: "pointer" }} src="https://storage-masivdrive.masivapp.com/1703/98f65ca6-11a6-4aee-9260-9ade652ca57f/4794c789-5271-4343-89bd-01db134eed4b/eb9bcb10-b9d3-4c27-897c-05113a4a35b0/f5ae2a2c-4241-4220-a112-3e348bccc988.png" />}
                        {/* {generandoIdPse ? 'Generando...' : <img src="../assets/pse_logo.png" />} */}
                        ...
                        <tr key={index}>
                          ...
                          <td className="border border-gray-400 p-2">
                            {item.FechaVencimiento
                              ? `${item.FechaVencimiento.slice(0, 4)}/${item.FechaVencimiento.slice(4, 6)}/${item.FechaVencimiento.slice(6, 8)}`
                              : 'N/A'}
                          </td>
